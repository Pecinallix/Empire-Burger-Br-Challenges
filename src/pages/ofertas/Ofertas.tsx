  ...
  return (
    <div className="pt-64 bg-yellow-950 bg-opacity-5 grid grid-cols-1 lg:grid-cols-3 backdrop-blur-sm lg:pt-32 lg:pl-4 gap-4">
      ...
      <div className="ml-4 lg:ml-0 lg:col-start-1 lg:row-start-1 lg:col-span-2 lg:self-end">
        <h1 className="w-80 text-stone-950 text-opacity-90 text-2xl font-Lilita uppercase leading-7 mb-1 lg:w-[470px] lg:text-3xl">
          Ofertas especiais
        </h1>
        <p className="w-80 text-stone-950 text-opacity-70 text-base font-Lato leading-snug mb-2 lg:w-[777px]">
      ...
      <div className="mx-4 lg:mx-0 lg:col-start-1 lg:row-start-2 lg:col-span-2 lg:row-span-2">
        ...
        />
        <span className="  text-white text-opacity-70 text-xs font-normal font-Lato leading-3 absolute -mt-16 ml-72 sm:ml-80 lg:ml-[550px]">
          Apenas <br />
