    ...
    <div>
      <div>
        <img
          ...
          className="border-t border-stone-950 border-opacity-10 pt-16 w-96"
        />
      </div>
      <div className="mt-10">
        ...
        <div className="w-96 h-24 bg-white bg-opacity-70 rounded-xl shadow flex items-center justify-center mb-2">
          ...
          <div className="border-l border-opacity-10 border-black ml-6 pl-6">
            ...
            <p className="w-56 text-stone-950 text-opacity-70 text-sm font-Lato leading-tight">
        ...
        <div className="w-96 h-24 bg-white bg-opacity-70 rounded-xl shadow flex items-center justify-center mb-16">
          <span className="w-16 h-16 bg-orange-100 rounded-full flex justify-center items-center">
