...
const Menu = () => {
  return (
    <div className=" w-full h-16 flex bg-yellow-950 bg-opacity-5 backdrop-blur items-center fixed z-50 border-yellow-900 border-b border-opacity-10 lg:justify-center justify-between">
      ...
      <div className="hidden lg:flex items-center ml-16">
        ...
        <div className="flex gap-2 items-center ml-6 xl:ml-24">
          <svg
            width="28"
            height="15"
            viewBox="0 0 28 15"
